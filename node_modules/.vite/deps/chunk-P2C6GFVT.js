...
var StandardInteractionClient = class extends BaseInteractionClient {
  ...
  async getClientConfiguration(params) {
    ...
    const discoveredAuthority = params.authority || await invokeAsync(this.getDiscoveredAuthority.bind(this), PerformanceEvents.StandardInteractionClientGetDiscoveredAuthority, this.logger, this.performanceClient, this.correlationId)({
      requestAuthority,
...
async function handleResponseEAR(request, response, apiId, config, authority, browserStorage, nativeStorage, eventHandler, logger, performanceClient, platformAuthProvider) {
  ...
  return await invokeAsync(responseHandler.handleServerTokenResponse.bind(responseHandler), PerformanceEvents.HandleServerTokenResponse, logger, performanceClient, request.correlationId)(decryptedData, authority, TimeUtils_exports.nowSeconds(), request, apiId, additionalData, void 0, void 0, void 0, void 0);
}
...
function isPlatformAuthAllowed(config, logger, platformAuthProvider, authenticationScheme) {
  ...
  if (!config.system.allowPlatformBroker && config.system.allowPlatformBrokerWithDOM) {
...
var TokenCache = class {
  ...
  async loadExternalTokens(request, response, options) {
    ...
    try {
      ...
      rootMeasurement.end({ success: true }, void 0, AccountEntity.getAccountInfo(cacheRecordAccount));
  ...
  async loadAccount(request, clientInfo, correlationId, idTokenClaims, authority) {
    ...
    if (request.account) {
      ...
      await this.storage.setAccount(accountEntity, correlationId, AuthToken_exports.isKmsi(idTokenClaims || {}), ApiId.loadExternalTokens);
    ...
    await this.storage.setAccount(cachedAccount, correlationId, AuthToken_exports.isKmsi(idTokenClaims || {}), ApiId.loadExternalTokens);
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-KHFFBQMW.js");
    }
  } catch (e) {
  }
  return void 0;
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v4.28.0 2026-01-13 *)
*/
//# sourceMappingURL=chunk-P2C6GFVT.js.map
